...
export class CriticaParametroService {
    ...
    public async adicionar(conteudo: _modelsInput.CrticaParametro) {
        let parameters: IHttpClientRequestParameters
            = {
            url: Config.api + "/criticaParametro",
    ...
    public async atualizar(conteudo: _modelsInput.CrticaParametro) {
        let parameters: IHttpClientRequestParameters
            = {
            url: Config.api + "/criticaParametro",
